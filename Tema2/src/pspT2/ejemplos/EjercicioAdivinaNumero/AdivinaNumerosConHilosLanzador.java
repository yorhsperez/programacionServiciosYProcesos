...
class AdivinaNumerosConHilos implements Runnable {
    ...
    AdivinaNumerosConHilos(String nombre){
        ...
        int numeroAdivinado = ThreadLocalRandom.current().nextInt(1, 100);
        int contador = 0;
           ...
           // if para saber cual es el primer hilo que hizo break;
            if (adivinado==1){
                ...
                System.out.println("Ohhh, no he ganado ("+nombre+")");
            }
...
//        numero = random.getRandom();
        ...
        System.out.println("El numero a adivinar es: " + 10);
